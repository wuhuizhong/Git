...
(function ($) {
  $.widget("ui.master_detail_item", {
    ...
    // Fix for IR. Hide MASTER_ID column id header
      ...
      $(".masterDetailReport").find(":first-child").find(":last-child").css("display", "none");

      $(".js-stickyWidget-placeholder").height(0);
      $("#stickyTableHeader_2 table").children().css("display","none");
